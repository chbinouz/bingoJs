...
var seo = require('../../models/foldermodels/seo.model')

/* GET home page. */
router.get('/', function(req, res, next) {
    seo.find(function(err, data){
    if (err) throw err;
    res.json(data);
...
router.delete("/Deletehr/:id", async(req,res,next)=>{
  try {
    const profile = await seo.findByIdAndDelete(req.params.id);
