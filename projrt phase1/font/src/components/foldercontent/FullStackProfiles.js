...
import { FullStackProfileCard } from "../foldercontent/FullStackProfileCard";
...
export const FullStackProfiles = () => {
      ...
      >
        <Wrapper>
          {profiles?.map((profile, index) => (
            <FullStackProfileCard profile={profile} key={index}></FullStackProfileCard>
          ))}
        </Wrapper>
      </InfiniteScroll>
