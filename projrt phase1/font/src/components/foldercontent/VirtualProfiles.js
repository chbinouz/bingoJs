...
import { VirtualProfileCard } from "../foldercontent/VirtualProfileCard";
      ...
      >
        <Wrapper>
          {profiles?.map((profile, index) => (
            <VirtualProfileCard profile={profile} key={index}></VirtualProfileCard>
          ))}
        </Wrapper>
      </InfiniteScroll>
