...
import { AccountantsProfileCard } from "../foldercontent/AccountantsProfileCard";
...
export const AccountantProfiles = () => {
      ...
      >
        <Wrapper>
          {profiles?.map((profile, index) => (
            <AccountantsProfileCard profile={profile} key={index}></AccountantsProfileCard>
          ))}
        </Wrapper>
      </InfiniteScroll>
