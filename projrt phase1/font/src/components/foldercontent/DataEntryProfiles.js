...
import { DataEntryProfileCard } from "../foldercontent/DataEntryProfileCard";
...
export const DataEntryProfiles = () => {
      ...
      >
        <Wrapper>
          {profiles?.map((profile, index) => (
            <DataEntryProfileCard profile={profile} key={index}></DataEntryProfileCard>
          ))}
        </Wrapper>
      </InfiniteScroll>
