...
import { MarketingProfileCard } from "../foldercontent/MarketingProfileCard";
...
export const MarketingProfiles = () => {
      ...
      >
        <Wrapper>
          {profiles?.map((profile, index) => (
            <MarketingProfileCard profile={profile} key={index}></MarketingProfileCard>
          ))}
        </Wrapper>
      </InfiniteScroll>
