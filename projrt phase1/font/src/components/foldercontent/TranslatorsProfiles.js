...
import { TranslatorsProfileCard } from "../foldercontent/TranslatorsProfileCard";
...
export const TranslatorsProfiles = () => {
      ...
      >
        <Wrapper>
          {profiles?.map((profile, index) => (
            <TranslatorsProfileCard profile={profile} key={index}></TranslatorsProfileCard>
          ))}
        </Wrapper>
      </InfiniteScroll>
