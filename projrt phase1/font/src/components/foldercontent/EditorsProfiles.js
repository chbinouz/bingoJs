...
import { EditorsProfileCard } from "../foldercontent/EditorsProfileCard";
      ...
      >
        <Wrapper>
          {profiles?.map((profile, index) => (
            <EditorsProfileCard profile={profile} key={index}></EditorsProfileCard>
          ))}
        </Wrapper>
      </InfiniteScroll>
